@extends('user.layout.sidebar',['title'=>'Product'])
@section('content')
    <div class="col-md-12">
        <form action="{{ route('user.product.index') }}" name="sortingForm" id="sortingForm" method="GET">
            <div class="col-md-12 row my-4">
                <div class="col-md-2">
                    <div class="float-left mx-3">Latest Product <a
                            href="{{ route('user.product.index') }}">Here</a>.
                    </div>
                </div>
                <div class="col-md-1">
        ...
        @forelse($products as $product)
            <li class="custom-product">
                ...
                <ul class="cd-item-wrapper">
                    <a href="{{ route('user.product.productDetail',$product->id) }}">
                ...
                <div class="cd-item-info">
                    <b><a href="{{ route('user.product.productDetail',$product->id) }}">{{ $product->name }}</a></b>
                    <em class="cd-price text-success"><em style="font-size: small">Price:</em>
