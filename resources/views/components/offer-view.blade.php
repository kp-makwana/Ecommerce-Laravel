...
<div class="modal fade" id="view_offer_{{ $id }}" aria-hidden="true" aria-labelledby="exampleModalToggleLabel">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('admin.product.offer.update') }}" name="offer_update{{ $id }}"
                  id="offer_update_{{ $id }}"
                  method="POST">
                @csrf
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="mb-3 row">
                            <label for="start_date" class="col-md-3 col-form-label"><span class="text-danger">*</span>Offer
                                Start Date:</label>
                            <div class="col-sm-9">
                                @php  $s_date =  $bladeService->date_time($offer->start_date) @endphp
                        ...
                        <div class="mb-3 row">
                            <label for="end_date" class="col-md-3 col-form-label"><span class="text-danger">*</span>Offer
                                End Date:</label>
                            <div class="col-sm-9">
                                <input class="form-control" id="end_date" name="end_date" value="{{ $offer->end_date }}"
                                       type="datetime-local"/>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-success" onclick="validation({{ $id }})" value="Update"/>
                </div>
            </form>
        </div>
    </div>
